...
static SPI_COMMAND_LIST: &[SpiCmdValues] = &[
    SpiCmdValues { name: "read SFDP", cmd: 0x5a, address_type: AddressType::NoOff3B, pad_bytes: 0 },
    SpiCmdValues { name: "write status register", cmd: 0x01, address_type: AddressType::None, pad_bytes: 0 },
    SpiCmdValues { name: "page program", cmd: 0x02, address_type: AddressType::Dynamic, pad_bytes: 0 },
    SpiCmdValues { name: "read", cmd: 0x03, address_type: AddressType::Dynamic, pad_bytes: 0 },
    SpiCmdValues { name: "write disable", cmd: 0x04, address_type: AddressType::None, pad_bytes: 0 },
    SpiCmdValues { name: "read status register", cmd: 0x05, address_type: AddressType::None, pad_bytes: 0 },
    SpiCmdValues { name: "write enable", cmd: 0x06, address_type: AddressType::None, pad_bytes: 0 },
    SpiCmdValues { name: "fast read", cmd: 0x0b, address_type: AddressType::Dynamic, pad_bytes: 1 },
    SpiCmdValues { name: "EM100 specific", cmd: 0x11, address_type: AddressType::None, pad_bytes: 0 },
    SpiCmdValues { name: "fast dual read", cmd: 0x3b, address_type: AddressType::Dynamic, pad_bytes: 2 },
    SpiCmdValues { name: "chip erase", cmd: 0x60, address_type: AddressType::None, pad_bytes: 0 },
    SpiCmdValues { name: "read JEDEC ID", cmd: 0x9f, address_type: AddressType::None, pad_bytes: 0 },
    SpiCmdValues { name: "chip erase c7h", cmd: 0xc7, address_type: AddressType::None, pad_bytes: 0 },
    SpiCmdValues { name: "sector erase d8h", cmd: 0xd8, address_type: AddressType::Dynamic, pad_bytes: 0 },
    SpiCmdValues { name: "dual I/O read", cmd: 0xbb, address_type: AddressType::Dynamic, pad_bytes: 2 },
    SpiCmdValues { name: "quad I/O read", cmd: 0xeb, address_type: AddressType::Dynamic, pad_bytes: 0 },
    SpiCmdValues { name: "quad read", cmd: 0x6b, address_type: AddressType::Dynamic, pad_bytes: 0 },
    SpiCmdValues { name: "quad I/O dt read", cmd: 0xed, address_type: AddressType::Dynamic, pad_bytes: 0 },
    SpiCmdValues { name: "quad page program", cmd: 0x38, address_type: AddressType::Dynamic, pad_bytes: 0 },
    SpiCmdValues { name: "sector erase 20h", cmd: 0x20, address_type: AddressType::Dynamic, pad_bytes: 0 },
    SpiCmdValues { name: "block erase 32KB", cmd: 0x52, address_type: AddressType::Dynamic, pad_bytes: 0 },
    SpiCmdValues { name: "enter 4b mode", cmd: 0xb7, address_type: AddressType::None, pad_bytes: 0 },
    SpiCmdValues { name: "exit 4b mode", cmd: 0xe9, address_type: AddressType::None, pad_bytes: 0 },
    SpiCmdValues { name: "read 4b", cmd: 0x13, address_type: AddressType::Addr4B, pad_bytes: 0 },
    SpiCmdValues { name: "fast read 4b", cmd: 0x0c, address_type: AddressType::Addr4B, pad_bytes: 0 },
    SpiCmdValues { name: "dual I/O read 4b", cmd: 0xbc, address_type: AddressType::Addr4B, pad_bytes: 0 },
    SpiCmdValues { name: "dual out read 4b", cmd: 0x3c, address_type: AddressType::Addr4B, pad_bytes: 0 },
    SpiCmdValues { name: "quad I/O read 4b", cmd: 0xec, address_type: AddressType::Addr4B, pad_bytes: 0 },
    SpiCmdValues { name: "quad out read 4b", cmd: 0x6c, address_type: AddressType::Addr4B, pad_bytes: 0 },
    SpiCmdValues { name: "quad I/O dt read 4b", cmd: 0xee, address_type: AddressType::Addr4B, pad_bytes: 0 },
    SpiCmdValues { name: "page program 4b", cmd: 0x12, address_type: AddressType::Addr4B, pad_bytes: 0 },
    SpiCmdValues { name: "quad page program 4b", cmd: 0x3e, address_type: AddressType::Addr4B, pad_bytes: 0 },
    SpiCmdValues { name: "block erase 64KB 4b", cmd: 0xdc, address_type: AddressType::Addr4B, pad_bytes: 0 },
    SpiCmdValues { name: "block erase 32KB 4b", cmd: 0x5c, address_type: AddressType::Addr4B, pad_bytes: 0 },
    SpiCmdValues { name: "sector erase 4b", cmd: 0x21, address_type: AddressType::Addr4B, pad_bytes: 0 },
    SpiCmdValues { name: "enter quad I/O mode", cmd: 0x35, address_type: AddressType::None, pad_bytes: 0 },
    SpiCmdValues { name: "exit quad I/O mode", cmd: 0xf5, address_type: AddressType::None, pad_bytes: 0 },
    SpiCmdValues { name: "unknown command", cmd: 0xff, address_type: AddressType::None, pad_bytes: 0 },
];
